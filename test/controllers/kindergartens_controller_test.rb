...
class KindergartensControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create kindergarten" do
    assert_difference("Kindergarten.count") do
      post kindergartens_url, params: { kindergarten: { available: @kindergarten.available, city_id: @kindergarten.city_id, description: @kindergarten.description, email: @kindergarten.email, name: @kindergarten.name, phone: @kindergarten.phone, price: @kindergarten.price, user_id: @kindergarten.user_id } }
    end
  ...
  test "should update kindergarten" do
    patch kindergarten_url(@kindergarten), params: { kindergarten: { available: @kindergarten.available, city_id: @kindergarten.city_id, description: @kindergarten.description, email: @kindergarten.email, name: @kindergarten.name, phone: @kindergarten.phone, price: @kindergarten.price, user_id: @kindergarten.user_id } }
